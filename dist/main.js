...
// Initialize
const base = (() => {
  const currentDate = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(), "yyyy-MM-dd");
  const allProject = [];
  const todayProject = [];
